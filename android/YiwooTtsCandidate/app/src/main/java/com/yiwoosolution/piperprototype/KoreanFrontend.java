...
/** Frozen special-token frontend for the 8523 500K model. */
final class KoreanFrontend {
  ...
  static String normalize(String text) {
    return LegacyKoreanNormalizerBridge.normalize(null, text);
  }

  static String normalize(android.content.Context context, String text) {
    return LegacyKoreanNormalizerBridge.normalize(context, text);
  }
  ...
  static long[] ids(String phonemes) {
    // Reference Piper topology used by the special-token 500K training run.
